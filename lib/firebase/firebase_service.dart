...
class FirebaseService {
  ...
  static Future<void> requestWithdrawal(WithdrawalRequestModel request) async {
    try {
      ...
      // Notify Admin
      // (Optional: You could query for admins and send notifications to them)
    } catch (e) {
  ...
  // Helper method to stream the current user to get real-time wallet balance
  ...
  static void initUserListener() {
    ...
    _userSubscription = FirebaseFirestore.instance
      ...
      if (doc.exists) {
        ...
        print('UserModel.currentUser synced with Firestore. New balance: ${UserModel.currentUser?.walletBalance}');
      }
    });
  }
}
